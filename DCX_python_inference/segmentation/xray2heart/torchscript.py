...
checkpoint_file = 'checkpoints\\xray2heart.pth'
scripted_model_path = 'checkpoints\\xray2heart_111.mipx'
...
if __name__ == "__main__":
    ...
    dumy_data = torch.rand(1, 1, 512, 512).type(torch.cuda.FloatTensor)
